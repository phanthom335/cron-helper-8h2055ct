    """
    Cron Helper 8h2055ct
    ====================
    Zero-dependency command-line tool designed to monitor local resources efficiently.
...
return results
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Zero-dependency command-line tool designed to monitor local resources efficiently.")
